...
class ReadRequest extends BaseRequest {
   ...
   * 获取章节列表
   */
  getChapters(booId, sourceId, user, success, fail) {
    this.get(
   ...
   * 获取章节内容
   */
  getChapterContent(chapterId, sourceBookId, listsId, sourceId, user, success, fail) {
    this.get(
   ...
   * 获取资源列表
   */
  getSources(bookId, user, success, fail) {
    this.get(
